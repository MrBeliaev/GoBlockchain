...
const (
	...
	NODE_IP_RANGE_START          = 0
	NODE_IP_RANGE_END            = 1
	BLOCKCHIN_NODE_SYNC_TIME_SEC = 20
)
...
func (bc *Blockchain) StartSyncNodes() {
	bc.SyncNodes()
	_ = time.AfterFunc(time.Second*BLOCKCHIN_NODE_SYNC_TIME_SEC, bc.StartSyncNodes)
}
